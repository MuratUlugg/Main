...
using Yonetım.Module.BusinessObjects;
using DevExpress.ExpressApp.ReportsV2;

namespace Yonetım.Module {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/clsDevExpressExpressAppModuleBasetopic.aspx.
    public sealed partial class YonetımModule : ModuleBase {
        static YonetımModule() {
            ...
            // #if DEBUG
            // Database.SetInitializer(new DropCreateDatabaseIfModelChanges<YonetımDbContext>());
            // #endif 
        }
        public YonetımModule() {
            InitializeComponent();
